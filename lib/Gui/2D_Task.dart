...
class _Todo_widgetState extends State<Todo_widget> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < globals.ToDo_2D.length; i++) {
      list.addAll([
        Custom_Card_Todo(
          w: widget.w,
          task: globals.ToDo_2D[i],
          job: "2D Task",
        ),
        SizedBox(
          height: 5,
...
class _To_Review_widgetState extends State<To_Review_widget> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < globals.ToReview_2D.length; i++) {
      list.addAll([
        Custom_Card_Review(
          w: widget.w,
          task: globals.ToReview_2D[i],
          job: "2D Task",
        ),
        SizedBox(
          height: 5,
...
class _Completed_widgetState extends State<Completed_widget> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < globals.Completed_2D.length; i++) {
      list.addAll([
        Custom_Card_Completed(
          w: widget.w,
          task: globals.Completed_2D[i],
          job: "2D Task",
        ),
        SizedBox(
          height: 5,
